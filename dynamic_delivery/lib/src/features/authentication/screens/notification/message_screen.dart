  ...
  Future<void> fetchMostRecentDocument() async {
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        DocumentSnapshot? subSnapshot = subCollectionSnapshot.docs.isNotEmpty
      ...
      body: Center(
        child: isLoading
            ...
            : mostRecentDocument != null
                      ...
                      children: [
                        ...
                        Center(
                          child: ElevatedButton(
                            onPressed: () {
                              StatusController.instance.updateStatus(
                                  mostRecentDocument?.id, "Pickup initiated");
                              updateFirestore();
                              if (mostRecentDocument != null &&
                                  mostRecentDocument!.data() != null) {
                                Map<String, dynamic>? data = mostRecentDocument
                                    ?.data() as Map<String, dynamic>?;
                                if (data != null &&
                                    data.containsKey('Agent-Id')) {
                ...
                : const Text(
                    'No most recent document found or an error occurred.'),
      ),
    );
  }
}
